...
subtitle: "Variable: Temperature, Elevation, and Distance to Roads"
...
o3_projected$elev=round(raster::extract(added_data_projected1,o3_projected),2)
...
for(i in seq_along(cols)) {
  var_name = cols[i]
  v = autofitVariogram(reformulate("max_temp+elev+dist2road",var_name),year_o3)
  vgms[[i]] = v
}
# vgms
...
# for(i in seq_along(cols)) {
#   var_name = cols[i]
#   k = autoKrige(reformulate("max_temp+elev+dist2road",var_name),year_o3,grd, model = c("Ste","Sph","Mat","Exp","Nug","Gau","Lin"))
#   k.cv = autoKrige.cv(reformulate("max_temp+elev+dist2road",var_name),year_o3,model = c("Ste","Sph","Mat","Exp","Nug","Gau","Lin"))
