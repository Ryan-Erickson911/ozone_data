...
# Training Model
def_control <- trainControl(method = 'LOOCV',number = 16,index = kfolds,p = 1,savePredictions = 'final',seed = seeds)
model_tuned = train(mda8~.,data=ozone_data[,c(-2:-3,-8)],method='rf',trControl=def_control)
# outputs
ozone_data[model_tuned$pred$rowIndex,]
...
# Training Model
def_control <- trainControl(method = 'LOOCV',number = 16,index = kfolds,p = 1,savePredictions = 'final',seed = seeds)
model_tuned = train(mda8~.,data=ozone_data[,c(-2:-3,-8,-10,-11)],method='rf',trControl=def_control)
# outputs
#ozone_data[model_tuned$pred$rowIndex,]
model_tuned
#### Variable Importance
