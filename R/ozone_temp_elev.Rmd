...
subtitle: "Variable: Temperature and Elevation"
...
head(cbind(o3_projected$site_name,o3_projected$max_temp,o3_projected$elev))
...
year_o3 = year_o3 %>% 
  dplyr::select(c("site_name","elev","max_temp","long","lat"),everything())
...
for(i in seq_along(cols)) {
  var_name = cols[i]
  v = autofitVariogram(reformulate("max_temp+elev",var_name),year_o3)
  vgms[[i]] = v
}
# vgms
...
# for(i in seq_along(cols)) {
#   var_name = cols[i]
#   k = autoKrige(reformulate("max_temp+elev",var_name),year_o3,grd, model = c("Ste","Sph","Mat","Exp","Nug","Gau","Lin"))
#   k.cv = autoKrige.cv(reformulate("max_temp+elev",var_name),year_o3,model = c("Ste","Sph","Mat","Exp","Nug","Gau","Lin"))
